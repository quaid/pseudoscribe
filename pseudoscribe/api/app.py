...
from pseudoscribe.api import tenant_config, role, style, vsc004_style, vsc005_live_suggestions, performance
...
app.include_router(vsc005_live_suggestions.router)
